...
#
# NRC Pipelines is free software: you can redistribute it and/or modify
# it under the terms of the GNU Lesser General Public License as published by
# the Free Software Foundation, either version 3 of the License, or
# (at your option) any later version.
#
# NRC Pipelines is distributed in the hope that it will be useful,
...
# Abstract pipeline gathering common features of all NRC pipelines (readsets, samples, remote log, etc.)
class NRCPipeline(Pipeline):
    ...
    def __init__(self):
        ...
        super(NRCPipeline, self).__init__()
...
#""".format(separator_line = "#" + "-" * 79, server=server, request=request))
    ...
    def submit_jobs(self):
        super(NRCPipeline, self).scheduler.submit(self)
