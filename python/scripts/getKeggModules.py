...
def main(arguments):
    ...
    sys.stderr.write("[DEBUG] " + infile_blastp + "\n")
    sys.stderr.write("[DEBUG] " + infile_gene_abundance + "\n")
    ...
    sys.stderr.write("[DEBUG]" + " Done parsing blastp results\n")
    ...
    sys.stderr.write("[DEBUG]" + " Done parsing gene_abundance table\n")
